...
public class PolygonsMain
{
  ...
  public static void main(String[] args) {
     ...
     * and/or --output is specified, run the AlgoRunner 3. If none of the above
     * is specified, show the GUI, disregarding any other option. + In case a
     * user-supplied value is inapplicable or has a wrong format, tell the user
     * and display help.
     */
    ...
    if (clp.isHelp()) {
      ...
      if (output == null && database == null) {
        ...
        AlgorithmRunner.run(number, threads, database, output, factory, params);        
      }
    }
  }
  ...
  private static class CommandLineParser
  {
    ...
    public boolean parseCommandLine(String[] args) {
      ...
      Option points = OptionBuilder
          ...
          .withDescription("The number of points of the polygons to generate (Default: " + defaultPoints + ")")
          .hasArg()
          .isRequired(false)
      ...
      Option number = OptionBuilder
          ...
          .withDescription("The number of polygons to generate (Default: " + defaultNumber + ")")
          .hasArg()
          .isRequired(false)
          .withType(Integer.class)
          .create();
      ...
      Option database = OptionBuilder
          .withLongOpt("database")
          .withArgName("Database file")
          .withDescription("The path to the database file (will be created automatically)")
          .hasArg()
          .isRequired(false)
      ...
      Option output = OptionBuilder
          ...
          .withDescription("When specified, the generated polygons will be saved at this path with a fixed-digit trailing index number.")
          .hasArg()
          .isRequired(false)
          .withType(String.class)
          .create();
      ...
      Option runs = OptionBuilder
          ...
          .withDescription("Number of iterations (Virmani's Velocity algorithm, default: " + defaultRuns + ")")
          .hasArg()
          .withType(Integer.class)
          .isRequired(false)
          .create();
      ...
      Option radius = OptionBuilder
          ...
          .withDescription("Radius of circle for initial regular polygon (Virmani's Velocity algorithm, default: " + defaultRadius + ")")
          .hasArg()
          .withType(Integer.class)
          .isRequired(false)
          .create();
      ...
      Option velocity = OptionBuilder
          ...
          .withDescription("Maximum velocity of moving points (Virmani's Velocity algorithm, default: " + defaultVelocity + ")")
          .hasArg()
          .withType(Integer.class)
          .isRequired(false)
          .create();
