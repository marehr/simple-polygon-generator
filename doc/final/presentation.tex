...
% TODO: change what did we accomplish

\begin{frame}{Final version\\- shortest path}
  \begin{itemize}
    % TODO: sebastian erklaehrt shortest path
    % zeigen am virmani
    \item original algorithm required trapezoidation
    % TODO: brauchts nicht mehr
    \item nicht mehr
    % TODO: runntime?
    \item runntime
...
\begin{frame}{Final version\\- analysis}
  ...
  \includegraphics[scale=0.8]{rpaggr/diagram1.pdf}
\end{frame}

\begin{frame}{Final version\\- analysis}
  Random Polygon Algorithm
  \includegraphics[scale=0.8]{rpaggr/diagram2.pdf}
\end{frame}
