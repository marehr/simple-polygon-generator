...
/**
 * Implementation of Polygon using ordered list. 
 * The assumption is, that the list of polygons is ordered in order 
 * of appearance. So the polygon is drawn from point one to point two to 
 * .. to point n to point 1. So be sure your self added point list meets 
 * the assumption otherwise it won't work.
 * 
 * @author bigzed
 */
public class OrderedListPolygon implements Polygon
{
   ...
   */
  public OrderedListPolygon(PStatistics stats) {
   ...
   */
  public OrderedListPolygon(List<Point> coords, PStatistics stats) {
    _coords = coords;
    _stats = stats;
  }
